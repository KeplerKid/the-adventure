...
//		}
        this.effects = new ArrayList<>(Arrays.asList(ability.get(
                "effects").split(",")));

        this.requirements = new ArrayList<>(Arrays.asList(ability.get(
                "requirements").split(",")));
     ...
     *
     * @param attacker   actor using the ability
     * @param attackRoll d20 attack roll used in conjunction with the ability
